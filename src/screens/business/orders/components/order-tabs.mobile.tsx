...
export type OrderTabValue = 'all' | 'Подтверждён' | 'Отменён';

export interface OrderTabsProps {
  options: { value: OrderTabValue; label: string }[];
  active: OrderTabValue;
  onChange: (next: OrderTabValue) => void;
  categoriesLabel: string;
}

export const OrderTabs = ({ options, active, onChange, categoriesLabel }: OrderTabsProps) => (
